...
#define CONFIG_QCLOUD_IOT_EXPLORER_ENABLED 1
#define CONFIG_SMART_LIGHT_ENABLED 1
#define CONFIG_DEMO_EXAMPLE_SELECT 0
#define CONFIG_WIFI_CONFIG_ENABLED 1
#define CONFIG_DEMO_WIFI_SSID "esp-office-2.4G"
#define CONFIG_DEMO_WIFI_PASSWORD "1qazxsw2"
